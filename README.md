...
Deployed link: https://krishi-era-ai-updj.vercel.app/login

we have provided pre-configured user personas that allow you to explore the platform’s full functionality.
